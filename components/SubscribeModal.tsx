      ...
      <View style={styles.contentContainer}>
        ...
        <BottomSheetScrollView>
          ...
          <Text style={styles.disclaimer}>
            If you subscribe to Hindustan Times via this app, payment for your
            ...
            will be automatically charged for renewal at the applicable rate
            shown to you at the time of subscription every calendar month (for
            monthly subscriptions) or every year (for annual subscriptions)
        ...
        <View style={[styles.footer, { paddingBottom: bottom }]}>
          <TouchableOpacity style={defaultStyles.btn}>
            {/* <TouchableOpacity> */}
            <Text style={defaultStyles.btnText}>Try For 7 Days</Text>
          </TouchableOpacity>
